...
def main() -> int:
    ...
    try:
        ...
        mecha_a: Mecha = MechaFactory.create_mecha_snapshot(config_a, weapon_configs=loader.equipments)
        mecha_b: Mecha = MechaFactory.create_mecha_snapshot(config_b, weapon_configs=loader.equipments)
